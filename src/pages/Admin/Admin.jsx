...
const Admin = () => {
  ...
  const renderComponent = () => {
    switch (activeLink) {
      ...
      case "courses":
        return <Courses />;
      // Add other cases for different sidebar links and respective components
      default:
        return <Dashboard />; // Default component to render
    }
  };
  return (
    <>
      <section className="bg-gray-100 dark:bg-gray-900">
        <aside className="fixed top-0 z-10 ml-[-100%] flex h-screen w-full flex-col justify-between border-r bg-white px-6 pb-3 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%] dark:bg-gray-800 dark:border-gray-700">
          <div>
            ...
            <ul className="mt-8 space-y-2 tracking-wide">
                ...
                <a
                  ...
                  className={
                    activeLink == "dashboard"
                      ...
                      : "relative flex items-center space-x-4 rounded-xl px-4 py-3 text-black"
                  }
                >
                  <svg
              ...
              <li onClick={() => setActiveLink("courses")}>
                <a
                  href="#"
                  className={
                    activeLink == "courses"
        ...
        <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
          ...
          <div className="px-6 pt-6 2xl:container">{renderComponent()}</div>
        </div>
      </section>
    </>
  );
